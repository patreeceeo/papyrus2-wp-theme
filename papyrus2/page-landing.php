...
<main class="p-bg-solid-dark p-slider p-slider--down u-full-height u-full-width" id="page-contact">
  ...
  <article class="p-content-area">
    ...
    <p>My typical rate is <strong>USD $40/hour</strong>, the rate for a given project may be slightly higher or lower depending on the nature of the work and is decided on a case-by-case basis. Consultation with the objective of defining or refining the Spec alluded to above is not included in billable hours.</p>
