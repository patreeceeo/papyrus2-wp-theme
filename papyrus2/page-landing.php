...
<main class="p-bg-solid-dark p-slider p-slider--down" id="page-contact">
  ...
  <article class="p-article">
    ...
    <p>Building quality software is not easy. It's not just about fulfilling those needs, wants and dreams, but it's also about providing peace of mind by being <em>maintainable</em>, <em>extensible</em>, <em>robust</em> and <em>secure</em>. That is why you should choose someone with a track record building software with these qualities, someone like <em>moi.</em>~</p>
